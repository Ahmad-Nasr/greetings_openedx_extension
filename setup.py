#!/usr/bin/env python
"""
Package metadata for greetings.
"""
import os
import re
import sys
...
VERSION = get_version('greetings', '__init__.py')
...
setup(
    name='greetings_extension',
    version=VERSION,
    description="""Simple extension plugin to OpenEdx platform""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/greetings_extension',
