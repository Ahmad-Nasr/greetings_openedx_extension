...
"""
greetings_extension documentation build configuration file.
...
project = 'greetings_extension'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Greetings openedx extension'
...
#
# html_title = 'greetings_extension v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Simple extension plugin to OpenEdx platform',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'greetings'),
                os.path.join(root_path, 'greetings/migrations')])
